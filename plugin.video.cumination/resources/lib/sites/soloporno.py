...
site = AdultSite('solo', '[COLOR hotpink]Solopornoitaliani.it[/COLOR]', 'https://solopornoitaliani.it/', 'https://reallifecam.to/images/logo/logo.png', 'rlc')

def getBaselink(url):
    if 'solopornoitaliani.it' in url:
        siteurl = site.url
